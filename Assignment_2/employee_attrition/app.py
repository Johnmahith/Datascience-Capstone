...
app.config["MONGO_URI"] = "mongodb://localhost:27017/DScapstone_project"
mongo = PyMongo(app)

# Load the model and tokenizer
tokenizer = AutoTokenizer.from_pretrained('D:\UMKC sem 4\DS cp\Assignment_2\using_API\direc_models\tokenizer')
model = AutoModelForCausalLM.from_pretrained('D:\UMKC sem 4\DS cp\Assignment_2\using_API\direc_models\models')
